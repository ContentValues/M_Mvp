...
public class JDAdapter extends XRecAdapter<HomeIndex.ItemInfoListBean, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PlaceHolder(LayoutInflater.from(context).inflate(R.layout.item_place_holder, parent, false));
    }
...
//        }
    ...
    public int getItemViewType(int position) {
       ...
       /* if ("topBanner".equals(bean.itemType)) {
        ...
        if ("iconList".equals(bean.itemType)) {
...
//    }
    ...
    private class PlaceHolder extends RecyclerView.ViewHolder {
        ...
        public PlaceHolder(View itemView) {
            super(itemView);
            mPlaceView = itemView.findViewById(R.id.mPlaceView);
        }

        private void bindData(HomeIndex.ItemInfoListBean item) {
            mPlaceView.setText(item.itemType);
        }
    }
