...
public class TestRSA {
    ...
    /**
     *
     * java项目调用androidStdio的包会报错Stub 所以可以利用JUNIT单元测试
     * @param args
     */
    public static void main(String[] args) {
        try {
            ...
            String privateKey = new String(Base64.encode(keyPair.getPrivate().getEncoded(), Base64.DEFAULT));
            String publicKey = new String(Base64.encode(keyPair.getPublic().getEncoded(), Base64.DEFAULT));
