...
//    @Inject
    ...
    private SharedPreferences getSharedPreferences(String fileName) {
        return mContext.getSharedPreferences(TextUtils.isEmpty(fileName) ? XDroidConf.SHARE_PREFERENCE_FILE_NAME : fileName, Context.MODE_PRIVATE);
    }
